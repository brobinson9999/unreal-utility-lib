class AssociationList extends BaseObject;

var private array<object> keys, values;

simulated protected function int getKeyIndex(object other) {
  local int i;
...
simulated protected function int getValueIndex(object other) {
  local int i;
...
simulated protected function removeIndex(int index) {
  keys.remove(index,1);
